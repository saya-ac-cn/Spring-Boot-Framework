package cn.saya.framework.api.rocketmq.consumer;
import cn.saya.framework.api.handle.MyException;
import cn.saya.framework.api.rocketmq.message.MessageListen;
import cn.saya.framework.api.rocketmq.message.MessageProcessor;
import cn.saya.framework.api.rocketmq.message.impl.AnimalProcessorImpl;
import cn.saya.framework.api.rocketmq.message.impl.UserProcessorImpl;
...
public class RocketMQConsumer {
    ...
    @Bean
    public DefaultMQPushConsumer getRocketMQConsumer() throws MyException{
